		...
		<div class="modal-content"> 
			...
			<form action="<?= base_url('member'); ?>" method="post"> 
				...
				<div class="modal-footer"> 
					...
					<button type="button" class="btn btn-outline-secondary" data-dismiss="modal">Close</button> <button type="submit" class="btn btn-outline-primary">Log in</button> 
		...
		<div class="modal-content"> 
			...
			<form action="<?= base_url('member/daftar'); ?>" method="post"> 
				...
				<div class="modal-footer"> 
					...
					<button type="button" class="btn btn-outline-secondary" data-dismiss="modal">Close</button> <button type="submit" class="btn btn-outline-primary">Simpan</button> 
...
<!--/end of Modal Daftar --> <!-- modal info--> 
